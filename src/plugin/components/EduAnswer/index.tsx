...
import DuplicateNameConfirm from '@sub-edu/components/DuplicateNameConfirm';
import ObservationRecord from '@sub-edu/components/ObservationRecord';
import ObservationPoints from '@sub-edu/components/ObservationPoints';
import GenerateObservationRecords from '@sub-edu/components/GenerateObservationRecords';
import IntelligentInfoExtraction from '@sub-edu/components/IntelligentInfoExtraction';
import { EEduBehaviorChatCard, EEduBehaviorTag, EResultType } from '@sub-edu/interface';
