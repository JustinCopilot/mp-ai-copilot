...
import { getObserveDetailApi, getStuDataDetailApi } from '@plugin/education/request';
import ReferenceDetail, { EModules } from '@plugin/education/components/ReferenceDetail';
