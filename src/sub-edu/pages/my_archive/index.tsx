...
import { getRandomNotesListApi, getMonthDataListApi } from '@sub-edu/request';
import { IGetRandomNotesListReq, IGetRandomNotesListRes, IGetMonthDataListReq } from '@sub-edu/request/type';
